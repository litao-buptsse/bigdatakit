from registry.docker.dev.sogou-inc.com:5000/clouddev/spark-client-sunshine-nm:1.6.2
RUN yum clean all && yum install java-1.8.0-oracle-devel.x86_64 -y && yum install mysql-server.x86_64 -y && yum clean all
